    ...
    if (valueObj["columnType"] === "text") {
        ...
        formatter: function(cell: any) {
          ...
          element.style.backgroundColor =
            ...
            valueObj.buttonColor === null
              ? Array.isArray(props.childStylesheet.iconButton.buttonColor) &&
                props.childStylesheet.iconButton.buttonColor.length
                ? props.childStylesheet.iconButton.buttonColor[0]
                : props.childStylesheet.iconButton.buttonColor.length === 7
                ? props.childStylesheet.iconButton.buttonColor
          ...
          element.style.color = valueObj.textColor || "white";
          const editable =
            multiRowSelect || singleRowSelect
              ? checkForSeletedRow(cell)
              : checkIfEditable(cell);
      ...
      for (const menuItems in valueObj.menuItems) {
        if (valueObj.menuItems[menuItems].isVisible) {
          objArray.push({
            label:
              `
          <span class="bp3-icon-standard bp3-icon-${valueObj.menuItems[
            menuItems
          ].iconName && valueObj.menuItems[menuItems].iconName} 
              "></span>
          ` + valueObj.menuItems[menuItems].label,
            ...
            disabled: valueObj.menuItems[menuItems].isDisabled,
            seperator: true,
          });
        }
      }
      editorConfig = {
        ...
        formatter: function(cell: any) {
          ...
          element.innerHTML = `
          <span class="bp3-icon-standard bp3-icon-${
            valueObj.iconName ? valueObj.iconName : ""
          }
           "></span><span> &nbsp  ${
